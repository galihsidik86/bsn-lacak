...
export function IOSDevice({ children, width = 402, height = 874, dark = false, title }: {
  children: ReactNode; width?: number; height?: number; dark?: boolean; title?: string;
}) {
  ...
  return (
    <div style={frame}>
      ...
      <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        {title !== undefined && <div style={{ paddingTop: 62, padding: '62px 16px 10px', fontSize: 34, fontWeight: 700, color: dark ? '#fff' : '#000' }}>{title}</div>}
